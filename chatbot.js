...
(function () {
  ...
  const FAQ_RULES = [
    ...
    { keywords: ['project', 'github', 'portfolio', 'work', 'lab', 'labs', 'devsecops', 'firewall', 'iptables', 'hyper-v', 'docker', 'wireshark', 'nmap', 'virtualization'], response: "I have home labs in DevSecOps, iptables firewall engineering, Hyper-V virtualization, Docker containers, network analysis with Wireshark and Nmap, and more. Check the Projects section for details and GitHub links." },
